...
/// </summary>
[Cmdlet(KaspaVerbNames.Get, "TransactionsCountForAddress")]
[OutputType(typeof(ResponseSchema))]
public sealed partial class GetTransactionsCountForAddress : KaspaPSCmdlet
{
...
----------------------------------------------------------------- */
    ...
    public GetTransactionsCountForAddress()
    {
