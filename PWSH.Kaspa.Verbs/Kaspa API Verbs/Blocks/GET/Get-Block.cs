...
/// </summary>
[Cmdlet(KaspaVerbNames.Get, "Block")]
[OutputType(typeof(ResponseSchema))]
public sealed partial class GetBlock : KaspaPSCmdlet
{
...
----------------------------------------------------------------- */
    ...
    protected override string BuildQuery()
    {
        ...
        queryParams["includeColor"] = IncludeColor.IsPresent.ToString().ToLower();

        return $"blocks/{BlockID}?" + queryParams.ToString();
    }
