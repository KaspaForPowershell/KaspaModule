namespace PWSH.Kaspa.Verbs
{
    ...
    /// </summary>
    [Cmdlet(KaspaVerbNames.Get, "Blocks")]
    [OutputType(typeof(ResponseSchema))]
    public sealed partial class GetBlocks : KaspaPSCmdlet
    {
...
----------------------------------------------------------------- */
        ...
        protected override string BuildQuery()
        {
            ...
            queryParams["includeBlocks"] = IncludeBlocks.IsPresent.ToString().ToLower();
            queryParams["includeTransactions"] = IncludeTransactions.IsPresent.ToString().ToLower();
            if (!string.IsNullOrEmpty(LowHash)) queryParams["lowHash"] = LowHash.ToString();

            return $"blocks?" + queryParams.ToString();
        }
