...
----------------------------------------------------------------- */
        ...
        public override int GetHashCode()
        {
            var hash = HashCode.Combine(Version, HashMerkleRoot, AcceptedIdMerkleRoot, UTXOCommitment, Timestamp, Bits);
            hash = HashCode.Combine(hash, Nonce, DaaScore, BlueWork);
...
----------------------------------------------------------------- */
        ...
        public override int GetHashCode()
        {
            var hash = Outputs.GenerateHashCode(0);
