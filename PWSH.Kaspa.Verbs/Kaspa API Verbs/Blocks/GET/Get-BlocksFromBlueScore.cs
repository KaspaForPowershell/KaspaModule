...
namespace PWSH.Kaspa.Verbs
{
    ...
    /// </summary>
    [Cmdlet(KaspaVerbNames.Get, "BlocksFromBlueScore")]
    [OutputType(typeof(List<ResponseSchema>))]
    public sealed partial class GetBlocksFromBlueScore : KaspaPSCmdlet
    {
...
----------------------------------------------------------------- */
        ...
        protected override string BuildQuery()
        {
            ...
            queryParams["blueScore"] = BlueScore.ToString();
            queryParams["includeTransactions"] = IncludeTransactions.IsPresent.ToString().ToLower();

            return $"blocks-from-bluescore?" + queryParams.ToString();
        }
