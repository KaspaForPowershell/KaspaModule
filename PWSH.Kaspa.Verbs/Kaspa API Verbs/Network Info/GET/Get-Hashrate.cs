namespace PWSH.Kaspa.Verbs
{
    ...
    /// </summary>
    [Cmdlet(KaspaVerbNames.Get, "Hashrate")]
    [OutputType(typeof(decimal))]
    public sealed partial class GetHashrate : KaspaPSCmdlet
    {
            ...
            try
            {
                ...
                (
                    RightAsync: async ok =>
                    {
                        ...
                        return Right<ErrorRecord, decimal>(message.RightToList()[0].Hashrate);
                    },
                    Left: err => err
                );
            }
