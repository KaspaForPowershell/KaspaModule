...
{
    /// <summary>
    /// Returns the current max hashrate for Kaspa network in TH/s.
    /// </summary>
    [Cmdlet(KaspaVerbNames.Get, "MaxHashrate")]
    [OutputType(typeof(ResponseSchema))]
    public sealed partial class GetMaxHashrate : KaspaPSCmdlet
    {
